...
CChatSerDlg::CChatSerDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CChatSerDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CChatSerDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
void CChatSerDlg::OnTimer(UINT_PTR nIDEvent)
{
